<!-- filter form-->
<div class="row">
	<?=form_open(admin_url('jobs/get_ajax_list'),'onsubmit="return SendForm(this)" id="filter_form" class="form-search" ')?>
	  <div class="span2">
		<a href="<?php echo admin_url('jobs/add')?>" class="btn" id="add">Add (F4)</a>
	  </div>
...
<div id="list">
	<?php $this->load->view('admin/jobs/jobs_list');?>
</div>
...
<!--
	...
	$(function(){
	 ...
	 function DeleteItem(id, obj){
		SimpleDelete(id, obj, index_url+"admin/jobs/delete");
	 }

	 function Activate(id, obj) {
	 	SimpleActivate(id, obj, index_url+"admin/jobs/activate");
	 }
