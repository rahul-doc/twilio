...
<div class="row">
	<?=form_open(admin_url('doctors/get_ajax_list'), 'id="filter_form" class="form-search" onsubmit="return SendForm(this)"' )?>	
   <div class="span2">
		<a  href="<?php echo admin_url('doctors/add')?>" class="btn" id="add">Add New</a>
	</div>
...
<div id="list">
<?php $this->load->view('admin/doctors/doctors_list');?>
</div>
...
<!--
	...
	$(function(){
	 ...
	 function DeleteItem(id, obj){
	   	url = admin_url+"doctors/delete";
		SimpleDelete(id, obj, url);
	 }

	 function Activate(id, obj)
	 {
	 	SimpleActivate(id, obj, admin_url+"doctors/activate");
	 }
