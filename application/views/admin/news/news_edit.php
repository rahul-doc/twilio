<?=form_open(admin_url('news/save'), 'onsubmit="return SendForm(this);"')?>
	...
	<div>
		...
		<input type="text" class="span8"  name="title" value="<?=$item->title?>" autofocus="autofocus"/>
	</div>

	<div>
		<label>List Start Date (yyyy-mm-dd	) <b class="err err_list_start_date"></b></label>
		<input type="text" data-mask="9999-99-99" name="list_start_date" value="<?php echo $item->list_start_date ? date('Y-m-d', strtotime($item->list_start_date)) : date('Y-m-d')?>"/>
	</div>

	<div>
		<label>List End Date (yyyy-mm-dd	) <b class="err err_list_end_date"></b></label>
		<input type="text" data-mask="9999-99-99" name="list_end_date" value="<?php echo $item->list_end_date ? date('Y-m-d', strtotime($item->list_end_date)) : ''?>"/>
	</div>
	...
	<div>
		...
		<textarea class="span12" id="wysiwyg" name="description" ><?=$item->description?></textarea>
	</div>
