...
<div class="row">
	<?=form_open(admin_url('patients/get_ajax_list'), 'id="filter_form" class="form-search" onsubmit="return SendForm(this)"' )?>	
   <div class="span2">
		<a  href="<?php echo admin_url('patients/add')?>" class="btn" id="add">Add New</a>
	</div>
...
<div id="list">
<?php $this->load->view('admin/patients/patients_list');?>
</div>
...
<!--
	...
	$(function(){
	 ...
	 function DeleteItem(id, obj){
	   	url = admin_url+"patients/delete";
		SimpleDelete(id, obj, url);
	 }

	 function Activate(id, obj)
	 {
	 	SimpleActivate(id, obj, admin_url+"patients/activate");
	 }
