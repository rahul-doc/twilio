...
<div class="row">
	<?=form_open(admin_url('price_list/get_ajax_list'), 'id="filter_form" class="form-search" onsubmit="return SendForm(this)"' )?>	
   <div class="span2">
		<a  href="<?php echo admin_url('price_list/add')?>" class="btn" id="add">Add New</a>
	</div>
	<div class="span10 text-right">
	   
	   <div class="input-append">
			<input type="text" class="search-query" placeholder="search item..." name="filter_provider" value="">
...
<div id="list">
<?php $this->load->view('admin/price_list/price_list');?>
</div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#clear_btn").on('click', function(){$("input[name=filter_provider]").val(''); SendFilter();})

	});

	 function DeleteItem(id, obj){
	   	url = admin_url+"price_list/delete";
