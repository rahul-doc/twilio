...
<div class="row" <?php echo $response['response']['success'] ? ' style="display:none;"' : '';?>>
	<?=form_open(admin_url('transactions/topup') )?>
        <div class="span10 text-left">
                <div style="margin-top:10px;">
                    <label>Patient Account ID <b class="err err_custom"></b></label>
                ...
                <div>
                    <label>Amount <b class="err err_amount"></b></label>
                    <input type="text" class="span1" readonly="readonly" name="currency" value="<?php echo $this->config->item('currency'); ?>" />&nbsp;<input type="text" class="span2" id="amount" name="amount" value="20"/>
                </div>
